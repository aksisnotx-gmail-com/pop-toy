<template>
  <div :style='{"padding":"30px","background":" url(http://codegen.caihongy.cn/20231205/b1037a84990a40d38531410083b9d519.jpg) repeat fixed center center / cover"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shejishi'"  label="工号" prop="gonghao">
          <el-input v-model="ruleForm.gonghao" readonly              placeholder="工号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shejishi'"  label="姓名" prop="xingming">
          <el-input v-model="ruleForm.xingming"               placeholder="姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='shejishi'"  label="性别" prop="xingbie">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shejishi'"  label="职位" prop="zhiwei">
          <el-input v-model="ruleForm.zhiwei"               placeholder="职位" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shejishi'"  label="联系方式" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi"               placeholder="联系方式" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shejishi'"  label="简介" prop="jianjie">
          <el-input v-model="ruleForm.jianjie"               placeholder="简介" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='shejishi'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.gonghao)&& 'shejishi'==this.flag){
      ...
      if((!this.ruleForm.xingming)&& 'shejishi'==this.flag){
      ...
      if( 'shejishi' ==this.flag && this.ruleForm.lianxifangshi&&(!isMobile(this.ruleForm.lianxifangshi))){
      ...
      if( 'shejishi' ==this.flag && this.ruleForm.thumbsupnum&&(!isIntNumer(this.ruleForm.thumbsupnum))){
       this.$message.error(`赞应输入整数`);
        return
      }


      if( 'shejishi' ==this.flag && this.ruleForm.crazilynum&&(!isIntNumer(this.ruleForm.crazilynum))){
       this.$message.error(`踩应输入整数`);
        return
      }


      if( 'shejishi' ==this.flag && this.ruleForm.money&&(!isNumber(this.ruleForm.money))){
