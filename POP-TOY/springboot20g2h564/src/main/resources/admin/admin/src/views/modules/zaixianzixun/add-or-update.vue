	...
	<div class="addEdit-block" :style='{"padding":"30px","background":" url(http://codegen.caihongy.cn/20231205/b1037a84990a40d38531410083b9d519.jpg) repeat fixed center center / cover"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="咨询时间" prop="zixunshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.zixunshijian" label="咨询时间" prop="zixunshijian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="提问" prop="tiwen">
					<el-input v-model="ruleForm.tiwen" placeholder="提问" clearable  :readonly="ro.tiwen"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="提问" prop="tiwen">
					<el-input v-model="ruleForm.tiwen" placeholder="提问" readonly></el-input>
				</el-form-item>
			</template>
